  ...
  console.log(dateformat);
      ...
      if($('.message-bubbles').length){
        ...
        $.ajax({
            ...
            url: ajaxurl,
            data: { 
                'action': 'listeo_admin_get_conversation', 
                'conversation_id' : $('input#conversation_id').val(),
                //'nonce': nonce
               },
            success: function(data){
            ...
            complete: function() {
              setTimeout(refreshAdminMessages, 4000);
            }
        });
 
      }
    }
    setTimeout(refreshAdminMessages, 4000); /*4000*/
