...
namespace WPStaging\Pro\Database\Legacy\Command\Dto;
...
class ExportDto
{
    ...
    const DEFAULT_FORMAT = ExportBackupCommand::FORMAT_GZIP;
    ...
    public function provideFileFormat()
    {
        switch ($this->getFormat()) {
            case ExportBackupCommand::FORMAT_GZIP:
                return 'sql.gz';
            case ExportBackupCommand::FORMAT_SQL:
                return 'sql';
            case ExportBackupCommand::FORMAT_BZIP2:
                return 'bz2';
        }
