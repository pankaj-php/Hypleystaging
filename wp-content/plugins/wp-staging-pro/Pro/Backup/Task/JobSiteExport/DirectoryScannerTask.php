...
use WPStaging\Pro\Backup\Task\JobSiteExport\Dto\DirectoryScannerRequestDto;
...
class DirectoryScannerTask extends AbstractTask
{
    ...
    public function __construct(DirectoryScannerControl $scannerControl, LoggerInterface $logger, Cache $cache)
    {
        ...
        // Allow DirectoryScanner to write to log
        WPStaging::getInstance()->getContainer()->singleton('DirectoryScannerTaskLogger', $logger);
