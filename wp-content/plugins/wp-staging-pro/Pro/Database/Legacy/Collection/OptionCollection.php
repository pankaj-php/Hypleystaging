...
namespace WPStaging\Pro\Database\Legacy\Collection;

use JsonSerializable;
use WPStaging\Pro\Database\Legacy\AbstractEntity;
use WPStaging\Pro\Database\Legacy\IdentifyableEntityInterface;
