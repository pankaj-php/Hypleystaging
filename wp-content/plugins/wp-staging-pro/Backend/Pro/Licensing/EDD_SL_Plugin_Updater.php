 ...
 * @version 1.8.0
 *
 * DON'T MODIFY THIS CLASS! It's not PSR4 and does not have proper coding style. It's an updater class included in the software by EDD: https://easydigitaldownloads.com/downloads/software-licensing/
 * For easy updating whenever EDD releases a new version of EDD Software Licenses
 * we want to keep the code differences as low as possible.
 */
