...
<?php if ( ! \Hummingbird\Core\Utils::is_member() ) : ?>
	...
	<div class="sui-actions-right">
		<a class="sui-button sui-button-purple" href="<?php echo esc_url( \Hummingbird\Core\Utils::get_link( 'plugin', 'hummingbird_dash_uptime_upgrade_button' ) ); ?>" target="_blank">
