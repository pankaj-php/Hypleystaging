...
use WPStaging\Pro\Backup\Task\JobSiteExport\Dto\FileScannerRequestDto;
...
class FileScannerTask extends AbstractTask
{
    ...
    protected function scanCurrentDirectory()
    {
        $files = null;
        try {
            $files = $this->scannerControl->scanCurrentPath($this->requestDto->getIncludeOtherFilesInWpContent(), $this->requestDto->getExcluded());
