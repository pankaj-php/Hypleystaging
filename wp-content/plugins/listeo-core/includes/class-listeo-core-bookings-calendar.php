...
//        if user dont have listings show his reservations
    ...
    */
    public static function insert_booking( $args )  {
        ...
        /*echo date( "Y-m-d H:i:s", strtotime( $args['date_start'] ) );
        echo $args['date_start'];*/

        /*echo "date_start".$args['date_start'];
        echo "<br";
        echo date( "Y-m-d H:i:s", strtotime( $args['date_start'] ) );
        echo "<br";

        echo "date_end".$args['date_end'];
        echo "<br";
        echo date( "Y-m-d H:i:s", strtotime( $args['date_end'] ) );*/
