...
use WPStaging\Pro\Database\Legacy\Command\Exception\ExportBackupException;
use WPStaging\Pro\Library\Mysqldump\Mysqldump;
use WPStaging\Vendor\Psr\Log\LoggerInterface;
use WPStaging\Framework\Database\TableService;
use WPStaging\Framework\Command\CommandInterface;

class ExportBackupCommand implements CommandInterface
{
    ...
    protected function generateSqlFile()
    {
        ...
        try {
            ...
            throw new ExportBackupException(sprintf(
