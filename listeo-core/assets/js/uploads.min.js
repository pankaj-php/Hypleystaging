    ...
    Dropzone.autoDiscover = false;
   	...
   	var galleryDropzone = new Dropzone ("#media-uploader._gallery", {
	    ...
	    success: function (file, response) {
			 if(file.width<1000 && file.size<50000)
	            {
	            	this.removeFile(file);
	            	alert("The uploaded photo did not fulfill the minimum requirement! Please make sure to upload high resolution pictures over 1,000 px.");
	            }else
				{
