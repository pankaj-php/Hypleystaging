...
abstract class AbstractTask
{
    ...
    {
        return (new \ReflectionClass($this))->getConstant('TASK_NAME');
    }
    ...
    {
        return __((new \ReflectionClass($this))->getConstant('TASK_TITLE'), 'wp-staging');
    }

    /**
     * @example 'backup.site.restore.themes'
     * @return string
     */
    public function getRequestNotation()
    {
        return (new \ReflectionClass($this))->getConstant('REQUEST_NOTATION');
    }

    /**
     * @example RestoreMergeFilesDto::class
     * @return string
     */
    public function getRequestDtoClass()
    {
        return (new \ReflectionClass($this))->getConstant('REQUEST_DTO_CLASS');
    }
    ...
    protected function findRequestDto()
    {
        ...
        $this->requestDto = WPStaging::getInstance()->getContainer()->make($dtoClass);
